...
<html>
	...
	<?php
		...
		//$NUMBER2 = $_GET['REQ2'];
		$sql = "SELECT count(DISTINCT cus_number) as num, pea_office.dept_name, debtor_kpi2.sap_code from debtor_kpi2 join pea_office on pea_office.sap_code = debtor_kpi2.sap_code where region2 LIKE '$NUMBER' GROUP BY debtor_kpi2.sap_code";
