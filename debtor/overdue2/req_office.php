...
<html>
	...
	<?php
		...
		$sql = "SELECT * from debtor_kpi2 where sap_code = '$NUMBER'";
		$query = mysqli_query($conn,$sql) or die(mysqli_error($conn));
		$mode2 = mysqli_num_rows($query);
		
		$sql2 = "SELECT * from debtor_kpi2 k join pea_office o on o.sap_code = k.sap_code where k.sap_code = '$NUMBER' GROUP BY k.cus_number";
