...
<html>
	...
	<?php
		...
		//$NUMBER2 = $_GET['REQ2'];
		$sql = "SELECT count(DISTINCT cus_number) as num, pea_office.dept_name, debtor_kpi4.sap_code from debtor_kpi4 join pea_office on pea_office.sap_code = debtor_kpi4.sap_code where region2 LIKE '$NUMBER' GROUP BY debtor_kpi4.sap_code";
			...
			<div data-role="content">	
				...
				<?php
					...
					while($result=mysqli_fetch_array($query)){
						$sql2 = "SELECT * from debtor_kpi4 where sap_code = '".$result['sap_code']."'";
