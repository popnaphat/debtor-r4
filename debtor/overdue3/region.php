...
<html>
	...
	<?php
		...
		$NUMBER = $_GET['REQ'];
			$dateupload = "SELECT bill_month FROM tbl_log_csv_debt4 where right(bill_month,4) = YEAR(CURRENT_DATE) and region = '$NUMBER' ORDER BY bill_month DESC LIMIT 1";
	...
	?>
		<div data-role="page" id="page">
			...
			<?php 
				...
				echo "<b>รายงานลูกหนี้ค่าไฟฟ้าเอกชนรายย่อยที่มีบิลค้างชำระเกิน 2 เดือนหรือไม่ต่อเนื่อง ปี $curyear (บิลเดือนล่าสุด $mmm) แยกตามสังกัดของ $reg เพียงวันที่ $ccc</b><br/>";
			?>
			</div>
			<div data-role="content">	
