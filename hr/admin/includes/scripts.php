...
<script>
  $(function () {
    ...
    $('#outdebtor-kpi3-grid').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax":{
		url :"kpi3_debtor_grid_data.php", // json datasource
		type: "post",  // method  , by default get
		error: function(){  // error handling
				$(".outdebtor-kpi3-grid-error").html("");
				$("#outdebtor-kpi3-grid").append('<tbody class="outdebtor-kpi-grid-error"><tr><th colspan="3">No data found in the server</th></tr></tbody>');
				$("#outdebtor-kpi3-grid_processing").css("display","none");
				}
		}
    } );
    $('#outdebtor-kpi4-grid').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax":{
		url :"kpi4_debtor_grid_data.php", // json datasource
		type: "post",  // method  , by default get
		error: function(){  // error handling
				$(".outdebtor-kpi4-grid-error").html("");
				$("#outdebtor-kpi4-grid").append('<tbody class="outdebtor-kpi-grid-error"><tr><th colspan="3">No data found in the server</th></tr></tbody>');
				$("#outdebtor-kpi4-grid_processing").css("display","none");
				}
		}
    } );
    $('#outdebtor-kpi5-grid').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax":{
		url :"kpi5_debtor_grid_data.php", // json datasource
		type: "post",  // method  , by default get
		error: function(){  // error handling
				$(".outdebtor-kpi5-grid-error").html("");
				$("#outdebtor-kpi5-grid").append('<tbody class="outdebtor-kpi-grid-error"><tr><th colspan="3">No data found in the server</th></tr></tbody>');
				$("#outdebtor-kpi5-grid_processing").css("display","none");
				}
		}
    } );
  })
